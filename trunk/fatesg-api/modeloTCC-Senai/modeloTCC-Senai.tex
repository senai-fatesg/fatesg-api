...
\autor{Glaicon da Silva Reis	}
\autorR{Reis, G. S.}
 
\autorD{Helivelton Tavares dos Santos	}    
\autorDR{Santos, H. S.}
     
\autorT{Rodrigo Gonçalves Rebelo}
\autorTR{Rebelo, G. R.}
  
\titulo{SGEP}
%--------------Para incluir subtitulo do Trabalho---------%
\subtitulo{Sistema de Gestão e Elaboração de Prova}
...
\input{./tex/cap4/cap_IV}             %Capitulo IV - Especificação de requesito
